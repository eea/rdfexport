...
public class ExploreDBTest {
    ...
    private static final String INVOICE_TABLES = "customer invoice invoice%20item organisation ";
    ...
    public void importDataSet() throws Exception {
        ...
        props.setProperty("sqldialect.h2.skiptables",
            ...
            + " ENUM_VALUES INDEX_COLUMNS"
            + " INFORMATION_SCHEMA_CATALOG_NAME QUERY_STATISTICS SYNONYMS"
    ...
    public void exploreInvoice() throws Exception {
        ...
        assertEquals("discovered tables", INVOICE_TABLES, props.getProperty("tables"));
