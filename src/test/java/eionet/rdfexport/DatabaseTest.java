...
public class DatabaseTest {
    ...
    private static final String PERSON_TABLES = "person ";
    ...
    public void importDataSet() throws Exception {
        ...
        props.setProperty("sqldialect.h2.skiptables",
            ...
            + " ENUM_VALUES INDEX_COLUMNS INFORMATION_SCHEMA_CATALOG_NAME"
            + " QUERY_STATISTICS SYNONYMS"
...
//      props.setProperty("sqldialect.h2.column.after", "");
   ...
   /**
    ...
    public void castToVarBinary() throws Exception {
        ...
        String expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
            ...
            + " <NAME>70</NAME>\n"
            + " <foaf:isPrimaryTopicOf rdf:resource=\"#test/3456\"/>\n"
            + "</Test>\n"
            + "</rdf:RDF>\n";
        assertEquals(expected, actual);
    }
   ...
   /**
    ...
    public void explorePersonTable() throws Exception {
        ...
        assertEquals("discovered tables", PERSON_TABLES, props.getProperty("tables"));
